...
const sfwhelp = new Discord.RichEmbed()
    ...
    .addField('Fun Commands', '`ping`, `hi`, `dog`, `meme`, `cat`, `8ball`, `wholesome`')
    .addField('Reddit Commands', '`technicallytruth`, ``boneappletea`, `bonehurtingjuice`, `dankmemes`')
    .addField('Utility Commands', '`uptime`, `user`, `avatar`, `server`')
...
const help = new Discord.RichEmbed()
    ...
    .setDescription('Command List')
    .addField('Fun Commands', '`hi`, `dog`, `meme`, `cat`, `8ball`, `wholesome`')
